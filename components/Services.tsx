...
const Services = () => {
  return (
    ...
    >
      ...
      <Card className="p-6 flex flex-col gap-3  w-[400px] bg-gradient-to-br  rounded-xl  hover:border-blue-400 shadow-sm  transition-transform duration-300 ease-in-out">
          <div className="p-0 mb-2  pb-2 border-b border-gray-200  w-full flex justify-between   items-center">
            ...
            <div className="  p-2 rounded-full">
              <LiaHandshakeSolid size={22} className="text-blue-500" />
            </div>
          </div>
       ...
       <p className="text-sm">
        ...
        <Card className="p-6 flex flex-col gap-3  w-[400px] bg-gradient-to-br  rounded-xl hover:border-blue-400 shadow-sm transform transition-transform duration-300 ease-in-out">
          <div className="p-0 mb-2  pb-2 border-b border-gray-200  w-full flex justify-between   items-center">
            <span className="text-lg font-medium text-gray-800">
            Consultancy basis
      ...
      <div className=" mt-5 py-2 flex flex-wrap items-center justify-center gap-5 w-full">
        <Card className="p-6 flex flex-col gap-3  w-[400px] bg-gradient-to-br  rounded-xl shadow-lg transform hover:scale-105 transition-transform duration-300 ease-in-out">
          <div className="p-0 mb-2  pb-2 border-b border-gray-200  w-full flex justify-between   items-center">
            <span className="text-lg font-medium text-gray-800">
            Consultancy basis

            </span>
            <div className=" bg-blue-500 animate-pulse p-2 rounded-full">
              <LiaHandshakeSolid size={22} className="text-white" />
            </div>
          </div>
          <CardContent className="p-0 flex-1 ">
